...
def packageChild(fake, config_params, childPackage):
    ...
    child_nationalId  = generate_nationalID(fake, config_params, childDOB, childGender, 1)[0]
    ...
    child_a = {             # Part of Family document - Still include Parent idNumbers, for coverage when marital_status = Divorce to reference the parent.
        ...
        "gender":               childGender,
        "dob":                  childDOB,
        "nationalid":           child_nationalId,
        "father_nationalid":    childPackage["maleId"],
        "mother_nationalid":    childPackage["femaleId"]    
    }
...
def packageAdults(fake, familyPackage, mylogger):
    ...
    male_uuid_id   = str(uuid.uuid4())
    female_uuid_id = str(uuid.uuid4())
    ...
    if familyPackage["male_livingstatus_status"] == "Living":
        ...
        male_a = {               # Family Package
            ...
            "nationalid":           familyPackage["maleId"],
            "gender":               "M",
        ...
        male_b = {               # Standalone Package
            "_id":                  male_uuid_id,  # Use UUID for MongoDB _id
            "name":                 male_firstName,
            "surname":              familyPackage["m_surname"],
            "nationalid":           familyPackage["maleId"],
            "gender":               "M",
    ...
    if familyPackage["female_livingstatus_status"] == "Living":
        female_a = {
            ...
            "nationalid":           familyPackage["femaleId"],
            "gender":               "F",
        ...
        female_b = {
            "_id":                  female_uuid_id,  # Use UUID for MongoDB _id
            "name":                 female_firstName,
            "surname":              familyPackage["f_surname"],
            "nationalid":           familyPackage["femaleId"],
            "gender":               "F",
